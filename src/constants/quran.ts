...
export const SURAH_LIST: SurahMeta[] = [
  ...
  { number: 3, nameAr: 'آل عمران', nameEn: 'Ali Imran', ayahCount: 200 },
  ...
  { number: 20, nameAr: 'طه', nameEn: 'Ta-Ha', ayahCount: 135 },
  ...
  { number: 93, nameAr: 'الضحى', nameEn: 'Ad-Duhaa', ayahCount: 11 },
...
export const surahByNumber = (number: number) =>
  SURAH_LIST.find((surah) => surah.number === number);
